    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#journal_vouchers_list').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'journal_vouchers.name', searchable: true },
                { data: 'delivery_time', name: 'journal_vouchers.delivery_time', searchable: true },
                { data: 'charge', name: 'journal_vouchers.charge', searchable: false },
            ],
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        ...
        $http({
            ...
            if (self.action == 'Edit') {
                ...
                if (self.attachment) {
                    $scope.PreviewImage = 'public/themes/' + self.theme + '/img/journal_voucher_logo/' + self.attachment.name;

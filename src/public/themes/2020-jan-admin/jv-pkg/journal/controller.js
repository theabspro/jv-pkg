    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope, $location) {
        ...
        var dataTable = $('#journals_list').DataTable({
            ...
            columns: [
                ...
                { data: 'name', name: 'journals.name', searchable: true },
                { data: 'delivery_time', name: 'journals.delivery_time', searchable: true },
                { data: 'charge', name: 'journals.charge', searchable: false },
            ],
        ...
        $('.add_new_button').html(
            '<a href="#!/jv-pkg/journal-voucher/add" type="button" class="btn btn-secondary" dusk="add-btn">' +
            'Add Journal Voucher' +
            '</a>'
        );
...
app.component('journalForm', {
    ...
    controller: function($http, $location, HelperService, $scope, $routeParams, $rootScope) {
        ...
        fileUpload();
        $http({
            url: laravel_routes['getJournalFormData'],
            method: 'GET',
            params: {
            ...
            if (self.action == 'Edit') {
                ...
                if (self.attachment) {
                    $scope.PreviewImage = 'public/themes/' + self.theme + '/img/journal_logo/' + self.attachment.name;
